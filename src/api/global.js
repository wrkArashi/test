...
const arr = [{
	...
	},
	{
		...
		sub: [
			...
			{
				name: "广东",
				sub: [{ name: "地级市、县" }, { name: "广州" }, { name: "深圳" }, { name: "珠海" }, { name: "汕头" }, { name: "韶关" }, { name: "佛山" },
					{ name: "江门" }, { name: "湛江" }, { name: "茂名" }, { name: "肇庆" }, { name: "惠州" }, { name: "梅州" }, { name: "汕尾" },
					{ name: "河源" }, { name: "阳江" }, { name: "清远" }, { name: "东莞" }, { name: "中山" }, { name: "潮州" }, { name: "揭阳" },
					{ name: "云浮" }
				],
				type: 0
			},
			{
				name: "安徽",
				sub: [{ name: "地级市、县" }, { name: "安庆" }, { name: "蚌埠" }, { name: "巢湖" }, { name: "池州" }, { name: "滁州" }, { name: "阜阳" },
					{ name: "合肥" }, { name: "淮北" }, { name: "淮南" }, { name: "黄山" }, { name: "六安" }, { name: "马鞍山" }, { name: "宿州" },
					{ name: "铜陵" }, { name: "芜湖" }, { name: "宣城" }, { name: "亳州" }
				],
				type: 0
			},
			{
				name: "福建",
				sub: [{ name: "地级市、县" }, { name: "福州" }, { name: "龙岩" }, { name: "南平" }, { name: "宁德" }, { name: "莆田" }, { name: "泉州" },
					{ name: "三明" }, { name: "厦门" }, { name: "漳州" }
				],
				type: 0
			},
			{
				name: "甘肃",
				sub: [{ name: "地级市、县" }, { name: "白银" }, { name: "定西" }, { name: "甘南藏族自治州" }, { name: "嘉峪关" }, { name: "金昌" },
					{ name: "酒泉" }, { name: "兰州" }, { name: "临夏回族自治州" }, { name: "陇南" }, { name: "平凉" }, { name: "庆阳" }, { name: "天水" },
					{ name: "武威" }, { name: "张掖" }
				],
				type: 0
			},
			{
				name: "广西",
				sub: [{ name: "地级市、县" }, { name: "百色" }, { name: "北海" }, { name: "崇左" }, { name: "防城港" }, { name: "桂林" }, { name: "贵港" },
					{ name: "河池" }, { name: "贺州" }, { name: "来宾" }, { name: "柳州" }, { name: "南宁" }, { name: "钦州" }, { name: "梧州" },
					{ name: "玉林" }
				],
				type: 0
			},
			{
				name: "贵州",
				sub: [{ name: "地级市、县" }, { name: "安顺" }, { name: "毕节" }, { name: "贵阳" }, { name: "六盘水" }, { name: "黔东南苗族侗族自治州" },
					{ name: "黔南布依族苗族自治州" }, { name: "黔西南布依族苗族自治州" }, { name: "铜仁" }, { name: "遵义" }
				],
				type: 0
			},
			{
				name: "海南",
				sub: [{ name: "地级市、县" }, { name: "白沙黎族自治县" }, { name: "保亭黎族苗族自治县" }, { name: "昌江黎族自治县" }, { name: "澄迈县" }, { name: "定安县" },
					{ name: "东方" }, { name: "海口" }, { name: "乐东黎族自治县" }, { name: "临高县" }, { name: "陵水黎族自治县" }, { name: "琼海" },
					{ name: "琼中黎族苗族自治县" }, { name: "三亚" }, { name: "屯昌县" }, { name: "万宁" }, { name: "文昌" }, { name: "五指山" }, { name: "儋州" }
				],
				type: 0
			},
			{
				name: "河北",
				sub: [{ name: "地级市、县" }, { name: "保定" }, { name: "沧州" }, { name: "承德" }, { name: "邯郸" }, { name: "衡水" }, { name: "廊坊" },
					{ name: "秦皇岛" }, { name: "石家庄" }, { name: "唐山" }, { name: "邢台" }, { name: "张家口" }
				],
				type: 0
			},
			{
				name: "河南",
				sub: [{ name: "地级市、县" }, { name: "安阳" }, { name: "鹤壁" }, { name: "济源" }, { name: "焦作" }, { name: "开封" }, { name: "洛阳" },
					{ name: "南阳" }, { name: "平顶山" }, { name: "三门峡" }, { name: "商丘" }, { name: "新乡" }, { name: "信阳" }, { name: "许昌" },
					{ name: "郑州" }, { name: "周口" }, { name: "驻马店" }, { name: "漯河" }, { name: "濮阳" }
				],
				type: 0
			},
			{
				name: "黑龙江",
				sub: [{ name: "地级市、县" }, { name: "大庆" }, { name: "大兴安岭" }, { name: "哈尔滨" }, { name: "鹤岗" }, { name: "黑河" },
					{ name: "鸡西" },
					{ name: "佳木斯" }, { name: "牡丹江" }, { name: "七台河" }, { name: "齐齐哈尔" }, { name: "双鸭山" }, { name: "绥化" }, { name: "伊春" }
				],
				type: 0
			},
			{
				name: "湖北",
				sub: [{ name: "地级市、县" }, { name: "鄂州" }, { name: "恩施土家族苗族自治州" }, { name: "黄冈" }, { name: "黄石" }, { name: "荆门" },
					{ name: "荆州" }, { name: "潜江" }, { name: "神农架林区" }, { name: "十堰" }, { name: "随州" }, { name: "天门" }, { name: "武汉" },
					{ name: "仙桃" }, { name: "咸宁" }, { name: "襄樊" }, { name: "孝感" }, { name: "宜昌" }
				],
				type: 0
			},
			{
				name: "湖南",
				sub: [{ name: "地级市、县" }, { name: "常德" }, { name: "长沙" }, { name: "郴州" }, { name: "衡阳" }, { name: "怀化" }, { name: "娄底" },
					{ name: "邵阳" }, { name: "湘潭" }, { name: "湘西土家族苗族自治州" }, { name: "益阳" }, { name: "永州" }, { name: "岳阳" }, { name: "张家界" },
					{ name: "株洲" }
				],
				type: 0
			},
			{
				name: "吉林",
				sub: [{ name: "地级市、县" }, { name: "白城" }, { name: "白山" }, { name: "长春" }, { name: "吉林" }, { name: "辽源" }, { name: "四平" },
					{ name: "松原" }, { name: "通化" }, { name: "延边朝鲜族自治州" }
				],
				type: 0
			},
			{
				name: "江苏",
				sub: [{ name: "地级市、县" }, { name: "常州" }, { name: "淮安" }, { name: "连云港" }, { name: "南京" }, { name: "南通" }, { name: "苏州" },
					{ name: "宿迁" }, { name: "泰州" }, { name: "无锡" }, { name: "无锡" }, { name: "盐城" }, { name: "扬州" }, { name: "镇江" }
				],
				type: 0
			},
			{
				name: "江西",
				sub: [{ name: "地级市、县" }, { name: "抚州" }, { name: "赣州" }, { name: "吉安" }, { name: "景德镇" }, { name: "九江" }, { name: "南昌" },
					{ name: "萍乡" }, { name: "上饶" }, { name: "新余" }, { name: "宜春" }, { name: "鹰潭" }
				],
				type: 0
			},
			{
				name: "辽宁",
				sub: [{ name: "地级市、县" }, { name: "鞍山" }, { name: "本溪" }, { name: "朝阳" }, { name: "大连" }, { name: "丹东" }, { name: "抚顺" },
					{ name: "阜新" }, { name: "葫芦岛" }, { name: "锦州" }, { name: "辽阳" }, { name: "盘锦" }, { name: "沈阳" }, { name: "铁岭" },
					{ name: "营口" }
				],
				type: 0
			},
			{
				name: "内蒙古",
				sub: [{ name: "地级市、县" }, { name: "阿拉善盟" }, { name: "巴彦淖尔盟" }, { name: "包头" }, { name: "赤峰" }, { name: "鄂尔多斯" },
					{ name: "呼和浩特" }, { name: "呼伦贝尔" }, { name: "通辽" }, { name: "乌海" }, { name: "乌兰察布盟" }, { name: "锡林郭勒盟" },
					{ name: "兴安盟" }
				],
				type: 0
			},
			...
			{
				name: "青海",
				sub: [{ name: "地级市、县" }, { name: "果洛藏族自治州" }, { name: "海北藏族自治州" }, { name: "海东" }, { name: "海南藏族自治州" }, { name: "海西蒙古族藏族自治州" },
					{ name: "黄南藏族自治州" }, { name: "黄南藏族自治州" }, { name: "玉树藏族自治州" }
				],
				type: 0
			},
			{
				name: "山东",
				sub: [{ name: "地级市、县" }, { name: "滨州" }, { name: "德州" }, { name: "东营" }, { name: "菏泽" }, { name: "菏泽" }, { name: "济宁" },
					{ name: "莱芜" }, { name: "聊城" }, { name: "临沂" }, { name: "青岛" }, { name: "日照" }, { name: "泰安" }, { name: "威海" },
					{ name: "潍坊" }, { name: "烟台" }, { name: "枣庄" }, { name: "淄博" }
				],
				type: 0
			},
			{
				name: "山西",
				sub: [{ name: "地级市、县" }, { name: "长治" }, { name: "大同" }, { name: "晋城" }, { name: "晋中" }, { name: "临汾" }, { name: "吕梁" },
					{ name: "朔州" }, { name: "太原" }, { name: "忻州" }, { name: "阳泉" }, { name: "运城" }
				],
				type: 0
			},
			{
				name: "陕西",
				sub: [{ name: "地级市、县" }, { name: "安康" }, { name: "宝鸡" }, { name: "汉中" }, { name: "商洛" }, { name: "铜川" }, { name: "渭南" },
					{ name: "西安" }, { name: "咸阳" }, { name: "延安" }, { name: "榆林" }
				],
				type: 0
			},
			{
			...
			{
				name: "四川",
				sub: [{ name: "地级市、县" }, { name: "阿坝藏族羌族自治州" }, { name: "巴中" }, { name: "成都" }, { name: "达州" }, { name: "德阳" },
					{ name: "甘孜藏族自治州" }, { name: "广安" }, { name: "广元" }, { name: "乐山" }, { name: "凉山彝族自治州" }, { name: "眉山" },
					{ name: "绵阳" },
					{ name: "南充" }, { name: "内江" }, { name: "攀枝花" }, { name: "遂宁" }, { name: "雅安" }, { name: "宜宾" }, { name: "资阳" },
					{ name: "自贡" }, { name: "泸州" }
				],
				type: 0
			},
			...
			{
				name: "西藏",
				sub: [{ name: "地级市、县" }, { name: "阿里" }, { name: "昌都" }, { name: "拉萨" }, { name: "林芝" }, { name: "那曲" }, { name: "日喀则" },
					{ name: "山南" }
				],
				type: 0
			},
			{
				name: "新疆",
				sub: [{ name: "地级市、县" }, { name: "阿克苏" }, { name: "阿拉尔" }, { name: "巴音郭楞蒙古自治州" }, { name: "博尔塔拉蒙古自治州" }, { name: "昌吉回族自治州" },
					{ name: "哈密" }, { name: "和田" }, { name: "喀什" }, { name: "克拉玛依" }, { name: "克孜勒苏柯尔克孜自治州" }, { name: "石河子" },
					{ name: "图木舒克" }, { name: "吐鲁番" }, { name: "乌鲁木齐" }, { name: "五家渠" }, { name: "伊犁哈萨克自治州" }
				],
				type: 0
			},
			{
				name: "云南",
				sub: [{ name: "地级市、县" }, { name: "保山" }, { name: "楚雄彝族自治州" }, { name: "大理白族自治州" }, { name: "德宏傣族景颇族自治州" }, { name: "迪庆藏族自治州" },
					{ name: "红河哈尼族彝族自治州" }, { name: "昆明" }, { name: "丽江" }, { name: "临沧" }, { name: "怒江傈傈族自治州" }, { name: "曲靖" },
					{ name: "思茅" }, { name: "文山壮族苗族自治州" }, { name: "西双版纳傣族自治州" }, { name: "玉溪" }, { name: "昭通" }
				],
				type: 0
			},
			{
				name: "浙江",
				sub: [{ name: "地级市、县" }, { name: "杭州" }, { name: "湖州" }, { name: "嘉兴" }, { name: "金华" }, { name: "丽水" }, { name: "宁波" },
	...
	},
	{
		...
		sub: [{ name: "省份、州", sub: [] },
			...
			{
				name: "京畿道",
				sub: [{ name: "地级市、县" }, { name: "水原市" }, { name: "城南市" }, { name: "安山市" }, { name: "高阳市" }, { name: "安养市" },
					{ name: "富川市" }
				],
				type: 0
			},
	...
	},
	{
		...
		sub: [{ name: "省份、州", sub: [] },
			{
				name: "吉打 Kedah",
				sub: [{ name: "地级市、县" }, { name: "亚罗士打 Alor Setar" }, { name: "浮罗交怡 Langkawi" }, { name: "古邦巴素 Kubang Pasu" },
					{ name: "巴东得腊 Padang Terap" }, { name: "哥打士打 Kota Setar" }
				],
				type: 0
			},
			{
				name: "槟榔屿 Pulau Pinang",
				sub: [{ name: "地级市、县" }, { name: "槟城 George Town" }, { name: "北区（北海） Utara (Butterworth)" }, { name: "中区（大山脚） Tengah (Bkt. Mertajam)" },
					{ name: "南区（高渊） Selatan (Nibong Tebal)" }, { name: "东北 Timur Laut" }
				],
				type: 0
			},
			{
			...
			{
				name: "丁加奴 Terengganu",
				sub: [{ name: "地级市、县" }, { name: "瓜拉丁加奴 Kuala Terengganu" }, { name: "勿述 Besut" }, { name: "瓜拉丁加奴 Kuala Terengganu" },
					{ name: "龙运 Dungun" }, { name: "甘马挽 Kemaman" }
				],
				type: 0
			},
			{
				name: "彭亨 Pahang",
				sub: [{ name: "地级市、县" }, { name: "关丹 Kuantan" }, { name: "金马仑高原 Cameron Highlands" }, { name: "立卑 Lipis" },
					{ name: "关丹 Kuantan" },
					{ name: "而连突 Jerantut" }
				],
				type: 0
			...
			{
				name: "雪兰莪 Selangor",
				sub: [{ name: "地级市、县" }, { name: "莎亚南 Shah Alam" }, { name: "沙白安南 Sabak Bernam" }, { name: "乌鲁雪兰莪 Ulu Selangor" },
					{ name: "瓜拉雪兰莪 Kuala Selangor" }
				],
				type: 0
			},
			{
			...
			},
			{
				...
				sub: [{ name: "地级市、县" }, { name: "哥打京那峇鲁（亚庇） Kota Kinabalu" }, { name: "兰脑 Ranau" }, { name: "古打毛律 Kota Belud" },
					{ name: "斗亚兰 Tuaran" }
				],
				type: 0
			}
	...
	},
	{
		...
		sub: [{ name: "省份、州", sub: [] },
			...
			},
			{
				...
				sub: [{ name: "地级市、县" }, { name: "达曼 Dammam" }, { name: "胡富夫 Al-Hufūf" }, { name: "姆巴拉兹 Al-Mubarraz" }, { name: "朱拜勒 Al-Jubayl" },
					{ name: "哈费尔巴廷 Hafar al-Bātin" }
				],
				type: 0
			},
			{
	...
	},
	{
		...
		sub: [{ name: "省份、州", sub: [] },
			...
			{
				name: "平安南道",
				sub: [{ name: "地级市、县" }, { name: "南浦特级市" }, { name: "平城市" }, { name: "顺川市" }, { name: "德川市" }, { name: "安州市" },
					{ name: "价川市" }
				],
				type: 0
			},
		...
		sub: [{ name: "省份、州", sub: [] },
			{
				...
				sub: [{ name: "地级市、县" }, { name: "斯图加特  Stuttgart" }, { name: "卡尔斯鲁厄 Karlsruhe" }, { name: "弗赖堡 Freiburg" },
					{ name: "图宾根 Tübingen" }
				],
				type: 0
			},
			{
				name: "拜恩（巴伐利亚）  Bayern",
				sub: [{ name: "地级市、县" }, { name: "慕尼黑 München " }, { name: "下拜恩 Niederbayern" }, { name: "上普法尔茨 Oberpfalz" },
					{ name: "上弗兰肯 Oberfranken" }, { name: "中弗兰肯 Mittelfranken" }, { name: "外弗兰肯 Unterfranken" }, { name: "施瓦本 Schwaben" }
				],
				type: 0
			},
			{
	...
	},
	{
		...
		sub: [{ name: "省份、州", sub: [] },
			{
				name: "英格兰 England",
				sub: [{ name: "地级市、县" }, { name: "坎布里亚 Cumbria" }, { name: "兰开夏 Lancashire" }, { name: "布莱克本 Blackburn with Darwen" },
					{ name: "大曼彻斯特 Greater Manchester" }, { name: "柴郡 Cheshire " }, { name: "诺森伯兰 Northumberland" }, { name: "达勒姆 Durham" },
					{ name: "北约克郡 North Yorkshire" }, { name: "约克郡东区 East Riding of Yorkshire" }, { name: "西约克郡 West Yorkshire" },
					{ name: "南约克郡 South Yorkshire" }, { name: "林肯郡 Lincolnshire" }, { name: "诺丁汉郡 Nottinghamshire" }, { name: "南约克郡 South Yorkshire" },
					{ name: "斯塔福德郡 Staffordshire" }, { name: "诺福克 Norfolk" }, { name: "伦敦 London" }, { name: "白金汉郡 Buckinghamshire" },
					{ name: "牛津郡 Oxfordshire" }, { name: "格洛斯特郡 Gloucestershire" }
				],
				type: 0
			},
			{
				name: "威尔士 Wales",
				sub: [{ name: "地级市、县" }, { name: "康威 Conwy *" }, { name: "圭内斯 Gwynedd" }, { name: "锡尔迪金 Ceredigion" }, { name: "波伊斯 Powys" },
					{ name: "彭布罗克郡 Pembrokeshire" }, { name: "卡马森郡 Carmarthenshire" }
				],
				type: 0
			},
			{
				name: "苏格兰 Scotland",
				sub: [{ name: "地级市、县" }, { name: "苏格兰高地 Highland" }, { name: "马里 Moray" }, { name: "阿伯丁郡 Aberdeenshire" }, { name: "安格斯 Angus" },
					{ name: "珀斯-金罗斯 Perth and Kinross" }, { name: "法夫 Fife" }, { name: "斯特灵 Stirling" }, { name: "阿盖尔-比特 Argyll and Bute" },
					{ name: "苏格兰边界 Scottish Borders" }, { name: "邓弗里斯-加洛韦 Dumfries and Galloway" }
				],
				type: 0
			},
			{
				name: "北爱尔兰 Northern Ireland",
				sub: [{ name: "地级市、县" }, { name: "阿兹 Ards" }, { name: "卡斯尔雷 Castlereagh" }, { name: "唐 Down" }, { name: "贝尔法斯特 Belfast, City of" },
					{ name: "利斯本 Lisburn" }, { name: "巴利米纳 Ballymena" }, { name: "莫伊尔 Moyle" }, { name: "阿马 Armagh" }
				],
				type: 0
			}
		],
	...
	},
	{
		...
		sub: [{ name: "省份、州", sub: [] },
			{
				name: "穆斯特省 Munster",
				sub: [{ name: "地级市、县" }, { name: "科克 Cork" }, { name: "沃特福德 Waterford" }, { name: "利默里克 Limerick" }, { name: "凯里 Kerry" },
					{ name: "蒂珀雷里 Tipperary" }, { name: "克莱尔 Clare" }
				],
				type: 0
			},
			{
				name: "康诺特省 Connacht",
				sub: [{ name: "地级市、县" }, { name: "戈尔韦 Galway" }, { name: "梅奥 Mayo" }, { name: "罗斯康芒  Roscommon" }, { name: "利特里姆  Leitrim" },
					{ name: "斯莱戈 Sligo" }
				],
				type: 0
			},
			{
				name: "伦斯特省 Leinster",
				sub: [{ name: "地级市、县" }, { name: "都柏林 Dublin" }, { name: "基尔代尔 Kildare" }, { name: "米斯 Meath" }, { name: "威克洛 Wicklow" },
					{ name: "西米斯 Westmeath" }, { name: "卡范 Cavan" }, { name: "朗福德 Longford" }, { name: "奥法利  Offaly" }, { name: "崂斯  Laoighis" },
					{ name: "卡洛 Carlow" }, { name: "基尔肯尼 Kilkenny" }, { name: "韦克斯福德 Wexford" }
				],
				type: 0
			},
			{
				name: "阿尔斯特省 Ulster",
				sub: [{ name: "地级市、县" }, { name: "劳斯 Louth" }, { name: "多内加尔 Donegal" }, { name: "莫内根 Monaghan" }, { name: "阿马 Armagh" },
					{ name: "安特里姆 Antrim" }, { name: "德里 Derry" }, { name: "唐 Down" }, { name: "泰隆 Tyrone" }, { name: "弗马纳 Fermanagh" }
				],
				type: 0
			}
		],
	...
	},
	{
		...
		sub: [{ name: "省份、州", sub: [] },
			...
			},
			{
				...
				sub: [{ name: "地级市、县" }, { name: "华沙" }, { name: "切哈努夫" }, { name: "普沃茨克" }, { name: "奥斯特罗文卡" }, { name: "谢德尔采" },
					{ name: "拉多姆" }
				],
				type: 0
			},
			...
			{
				name: "西里西亚 Slaskie",
				sub: [{ name: "地级市、县" }, { name: "卡托维兹" }, { name: "琴斯托霍瓦" }, { name: "别尔斯科-比亚瓦" }, { name: "雷布尼克" }, { name: "索斯诺维茨" },
					{ name: "格利维采" }, { name: "比托姆" }
				],
				type: 0
			},
		...
		sub: [{ name: "省份、州", sub: [] },
			{
				...
				sub: [{ name: "地级市、县" }, { name: "阿尔梅里亚 Almería" }, { name: "加的斯 Cádiz" }, { name: "科尔多瓦 Córdoba" }, { name: "格拉纳达 Granada" },
					{ name: "韦尔瓦 Huelva" }, { name: "哈恩 Jáen" }, { name: "马拉加 Málaga" }, { name: "塞维利亚 Sevilla" }
				],
				type: 0
			},
			{
			...
			},
			{
				...
				sub: [{ name: "地级市、县" }, { name: "阿尔瓦塞特 Albacete" }, { name: "雷阿尔城 Ciudad Real" }, { name: "昆卡 Cuenca" }, { name: "瓜达拉哈拉 Guadalajara" },
					{ name: "托莱多 Toledo" }
				],
				type: 0
			},
			{
				...
				sub: [{ name: "地级市、县" }, { name: "阿维拉 ávila" }, { name: "布尔戈斯 Burgos" }, { name: "莱昂 León" }, { name: "帕伦西亚 Palencia" },
					{ name: "萨拉曼卡 Salamanca" }, { name: "塞哥维亚 Segovia" }, { name: "索里亚 Soria" }, { name: "巴利亚多利德 Valladolid" },
					{ name: "萨莫拉 Zamora" }
				],
				type: 0
			},
		...
		sub: [{ name: "省份、州", sub: [] },
			{
				...
				sub: [{ name: "地级市、县" }, { name: "阿尔汉格尔斯克州 Archangel'sk Obl." }, { name: "涅涅茨自治区 Nenetskiy AOK" }, { name: "圣彼得堡市 Gorod Sankt-Peterburg" },
					{ name: "加里宁格勒州 Kaliningrad Obl." }, { name: "卡累利阿共和国 Karelija ARep." }, { name: "科米共和国 Komi ARep." }, { name: "列宁格勒州 Leningrad Obl." },
					{ name: "摩尔曼斯克州 Murmansk Obl." }, { name: "诺夫哥罗德州 Novgorod Obl." }, { name: "普斯科夫州 Pskov Obl." }, { name: "沃洛格达州 Vologda Obl." }
				],
				type: 0
			},
			{
				name: "中央 Central'nyj ",
				sub: [{ name: "地级市、县" }, { name: "别尔哥罗德州 Belgorod Obl." }, { name: "布良斯克州 Br'ansk Obl." }, { name: "莫斯科市 Gorod Moskva." },
					{ name: "伊万诺沃州 Ivanovo Obl." }, { name: "雅罗斯拉夫尔州 Jaroslavl' Obl." }, { name: "卡卢加州 Kaluga Obl." }, { name: "库尔斯克州 Kursk Obl." },
					{ name: "莫斯科州 Moskva Obl." }
				],
				type: 0
			},
			{
				name: "南方 Juznyj",
				sub: [{ name: "地级市、县" }, { name: "阿迪格共和国 Adygeja ARep." }, { name: "阿斯特拉罕州 Astrachan' Obl." }, { name: "车臣共和国 Cecenija ARep." },
					{ name: "达吉斯坦共和国 Dagestan  ARep." }, { name: "印古什共和国 Ingusetija ARep." }, { name: "卡巴尔达－巴尔卡尔共和国 Kabardino-Balkarija ARep." },
					{ name: "卡尔梅克共和国 Kalmykija ARep." }, { name: "卡拉恰耶夫－切尔克斯共和国 Karacajevo-Cerkesija ARep." }, { name: "克拉斯诺达尔边疆区 Krasnodar Kraj." },
					{ name: "罗斯托夫州 Rostov Obl." }, { name: "北奥塞梯－阿兰社会主义共和国 Severnaja Osetija-Alanija ARep." }, { name: "斯塔夫罗波尔边疆区 Stavropol' Kraj." },
					{ name: "伏尔加格勒州 Volgograd Obl." }
				],
				type: 0
			},
			{
				name: "伏尔加 Privolzskij",
				sub: [{ name: "地级市、县" }, { name: "巴什科尔托斯坦共和国 Ba?kortostan ARep." }, { name: "楚瓦什共和国 ?uva?ija  ARep." }, { name: "基洛夫州 Kirov  Obl." },
					{ name: "马里－埃尔共和国 Marij El  ARep." }, { name: "莫尔多瓦社会主义共和国 Mordovija  ARep." }, { name: "下诺夫哥罗德州 Niznij Novgorod  Obl." },
					{ name: "奥伦堡州 Orenburg  Obl." }, { name: "奔萨州 Penza  Obl." }, { name: "彼尔姆州 Perm'  Obl." }, { name: "科米－彼尔米亚克自治区  Komi-Permyatskiy AOK" },
					{ name: "萨马拉州 Samara  Obl." }, { name: "萨拉托夫州 Saratov  Obl." }
				],
				type: 0
			},
			{
				name: "乌拉尔 Ural'skij",
				sub: [{ name: "地级市、县" }, { name: "车里雅宾斯克州 Cel'abinsk Obl." }, { name: "库尔干州 Kurgan Obl." }, { name: "斯维尔德洛夫斯克州 Sverdlovsk Obl." },
					{ name: "秋明州 T'umen' Obl." }, { name: "汉特－曼西自治区 Khanty-Mansiyskiy AOK" }, { name: "亚马尔－涅涅茨自治区 Yamalo-Nenetskiy AOK" }
				],
				type: 0
			},
			{
				name: "西伯利亚 Sibirskij",
				sub: [{ name: "地级市、县" }, { name: "赤塔州 Cita Obl." }, { name: "Чита г. 赤塔市" }, { name: "Балей 巴列伊市" }, { name: "Петровск-Забайкальский г. 外贝加尔的彼得罗夫斯克市" },
					{ name: "Борзя г. 博尔贾市" }, { name: "Краснокаменск г. 克拉斯诺卡缅斯克市" }, { name: "Северобайкальск г. 北贝加尔斯克市" },
					{ name: "Улан-Удэ г. 乌兰乌德市" }, { name: "Гусиноозерск г. 古西诺奥泽尔斯克市" }, { name: "伊尔库茨克州 Irkutsk Obl." }, { name: "Усть-Кут г. 乌斯季库特市" },
					{ name: "Бодайбо 博代博市" }, { name: "Тайшет г. 泰舍特市" }, { name: "Братск г. 布拉茨克市" }, { name: "Нижнеудинск г. 下乌金斯克市" },
					{ name: "Тулун 图伦市" }, { name: "Саянск 萨彦斯克市" }, { name: "特瓦共和国 Tyva ARep." }, { name: "克拉斯诺亚尔斯克边疆区 Krasnojarsk ARep." },
					{ name: "哈卡斯共和国 Chakasija ARep." }, { name: "阿尔泰共和国 Altaj  ARep." }, { name: "阿尔泰边疆区 Altaskij Kraj" }, { name: "克麦罗沃州 Kemerovo Obl." },
					{ name: "新西伯利亚州 Novosibirsk Obl." }, { name: "托木斯克州 Tomsk Obl." }, { name: "鄂木斯克州 Omsk Obl." }
				],
				type: 0
			},
			{
				name: "远东 Dal'nevostocnij",
				sub: [{ name: "地级市、县" }, { name: "滨海边疆区 Приморский край/ Primorskij Kraj." }, { name: "哈巴罗夫斯克边疆区 Хабаровский край/ Chabarovsk Kraj." },
					{ name: "犹太自治州 Еврейская автономная область/Jevrej AArea." }, { name: "阿穆尔州 Amur Obl." }, { name: "萨哈林州 Sakhalin Obl." },
					{ name: "马加丹州 Magadan Obl." }, { name: "勘察加州 Kamcatka Obl." }, { name: "楚科奇自治专区 Cukotskij Avtonomnyj Okrug AArea." },
					{ name: "萨哈（雅库特）共和国 Sacha (Jakutija) ARep." }
				],
				type: 0
			}
		],
	...
	},
	{
		...
		sub: [{ name: "省份、州", sub: [] },
			...
			},
			{
				...
				sub: [{ name: "地级市、县" }, { name: "斯海尔托亨博思 's-Hertogenbosch" }, { name: "布雷达 Breda" }, { name: "艾恩德霍芬 Eindhoven" },
					{ name: "蒂尔堡 Tilburg" }
				],
				type: 0
			},
			...
			},
			{
				...
				sub: [{ name: "地级市、县" }, { name: "海牙 's-Gravenhage" }, { name: "鹿特丹 Rotterdam" }, { name: "多德雷赫特 Dordrecht" },
					{ name: "莱顿 Leiden" }, { name: "佐特尔梅 Zoetermeer" }
				],
				type: 0
			}
		],
	...
	},
	{
		...
		sub: [{ name: "省份、州", sub: [] },
			...
			{
				name: "安大略省 Ontario",
				sub: [{ name: "地级市、县" }, { name: "多伦多 Toronto" }, { name: "渥太华 Ottawa" }, { name: "哈密尔顿 Hamilton" }, { name: "基奇纳 Kitchener" },
					{ name: "伦敦 London" }, { name: "圣卡塔琳娜 St. Catharines" }, { name: "温莎 Windsor" }, { name: "奥沙瓦 Oshawa" }, { name: "巴里 Barrie" },
					{ name: "金斯敦 Kingston" }, { name: "圭尔夫 Guelph" }, { name: "萨德伯里 Sudbury" }, { name: "桑德贝 Thunder Bay" }
				],
				type: 0
			},
			{
				name: "魁北克省 Québec",
				sub: [{ name: "地级市、县" }, { name: "魁北克 Québec" }, { name: "蒙特利尔 Montréal" }, { name: "舍布鲁克 Sherbrooke" }, { name: "钻石城 Trois-Rivières" },
					{ name: "希格蒂米 Chicoutimi" }
				],
				type: 0
			},
			{
			...
			},
			{
				...
				sub: [{ name: "地级市、县" }, { name: "维多利亚 Victoria" }, { name: "温哥华 Vancouver" }, { name: "阿伯茨福 Abbotsford" },
					{ name: "基劳纳 Kelowna" }
				],
				type: 0
			},
	...
	},
	{
		...
		sub: [{ name: "省份、州", sub: [] },
			...
			},
			{
				...
				sub: [{ name: "地级市、县" }, { name: "拉普拉塔 La Plata" }, { name: "布兰卡港 Bahía Blanca" }, { name: "马德普拉塔 Mar del Plata" },
					{ name: "圣尼古拉斯 San Nic+olás" }
				],
				type: 0
			},
			{
	...
	},
	{
		...
		sub: [{ name: "省份、州", sub: [] },
			...
			{
				name: "奥克兰 Auckland",
				sub: [{ name: "地级市、县" }, { name: "奥克兰 Auckland" }, { name: "马努考 Manukau" }, { name: "北岸 North Shore" }, { name: "怀塔科拉 Waitakere" },
					{ name: "罗得尼 Rodney" }, { name: "帕帕库拉 Papakura" }, { name: "富兰克林 Franklin (1)" }
				],
				type: 0
			},
			{
				name: "怀卡托 Waikato",
				sub: [{ name: "地级市、县" }, { name: "哈密尔顿  Hamilton" }, { name: "怀卡托 Waikato" }, { name: "怀帕 Waipa" }, { name: "Otorohanga" },
					{ name: "Waitomo (7)" }, { name: "Thames-Coromandel" }, { name: "Hauraki" }
				],
				type: 0
			},
			{
				name: "普伦蒂湾 Bay of Plenty",
				sub: [{ name: "地级市、县" }, { name: "Tauranga" }, { name: "Western Bay op Plenty" }, { name: "Rotorua (2)" }, { name: "Taupo (3)" },
					{ name: "瓦卡塔尼 Whakatane" }, { name: "Kawerau" }, { name: "Opotiki" }
				],
				type: 0
			},
			{
			...
			{
				name: "霍克湾 Hawkes Bay",
				sub: [{ name: "地级市、县" }, { name: "内皮尔 Napier" }, { name: "Wairoa" }, { name: "Taupo (3)" }, { name: "Hastings" },
					{ name: "Rangitikei (4)" }, { name: "Central Hawke's Bay" }
				],
				type: 0
			},
			{
				name: "玛纳瓦图/旺格努伊 Manawatu-Wanganui",
				sub: [{ name: "地级市、县" }, { name: "北帕默斯顿 Palmerston North" }, { name: "Tararua (6)" }, { name: "Horowhenua" },
					{ name: "Manawatu" }, { name: "Rangitikei (4)" }, { name: "Ruapehu" }, { name: "Wanganui" }, { name: "斯特拉特福德 Stratford (5)" }
				],
				type: 0
			},
			{
			...
			{
				name: "惠灵顿 Wellington",
				sub: [{ name: "地级市、县" }, { name: "Wellington" }, { name: "Lower Hutt ( Hutt )" }, { name: "Porirua" }, { name: "Upper Hutt" },
					{ name: "Kapiti Coast" }, { name: "Masterton" }, { name: "Carterton" }, { name: "South Wairarapa" }
				],
				type: 0
			},
			{
			...
			},
			{
				...
				sub: [{ name: "地级市、县" }, { name: "基督城 Christchurch" }, { name: "Kaikoura" }, { name: "Hurunui" }, { name: "班克斯半岛 Banks Peninsula" },
					{ name: "塞尔温 Selwyn" }
				],
				type: 0
			},
	...
	},
	{
		...
		sub: [{ name: "省份、州", sub: [] },
			...
			},
			{
				...
				sub: [{ name: "地级市、县" }, { name: "布里斯班 Brisbane" }, { name: "黄金海岸 Gold Coast" }, { name: "日光海岸 Caloundra" },
					{ name: "汤斯维尔 Townsville" }, { name: "凯恩斯 Cairns" }, { name: "图文巴 Toowoomba" }
				],
				type: 0
			},
			{
